...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            // admins:
            ['id' => 1, 'email' => 'truongvu5723@gmail.com', 'password' => Hash::make('truong@12345'), 'role' => 0],

            // employers:
            ['id' => 11, 'email' => 'company11@gmail.com', 'password' => Hash::make('company@12345'), 'role' => 2],
            ...
            // candidates:
            ['id' => 101, 'email' => 'chung@gmail.com', 'password' => Hash::make('chung12345'), 'role' => 1],
            ['id' => 102, 'email' => 'nam@gmail.com', 'password' => Hash::make('nam12345'), 'role' => 1],
            ['id' => 103, 'email' => 'phong@gmail.com', 'password' => Hash::make('phong12345'), 'role' => 1],
            ['id' => 104, 'email' => 'truong@gmail.com', 'password' => Hash::make('truong12345'), 'role' => 1],
            ['id' => 105, 'email' => 'huy@gmail.com', 'password' => Hash::make('huy12345'), 'role' => 1],
